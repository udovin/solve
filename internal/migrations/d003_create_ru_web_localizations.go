...
func (m d003) Apply(ctx context.Context, db *gosql.DB) error {
	...
	localizations := [][2]string{
		...
		{"datetime_future_hour:0", "через %d час"},
		{"datetime_future_hour:1", "через %d часа"},
		{"datetime_future_hour:2", "через %d часов"},
		{"datetime_future_minute:0", "через %d минуту"},
		{"datetime_future_minute:1", "через %d минуты"},
		{"datetime_future_minute:2", "через %d минут"},
		{"datetime_future_second:0", "через %d секунду"},
		{"datetime_future_second:1", "через %d секунды"},
		{"datetime_future_second:2", "через %d секунд"},
		{"datetime_input_placeholder", "ДД.ММ.ГГГГ чч:мм:сс"},
		{"datetime_now", "сейчас"},
		{"datetime_past_hour:0", "%d час назад"},
		{"datetime_past_hour:1", "%d часа назад"},
		{"datetime_past_hour:2", "%d часов назад"},
		{"datetime_past_minute:0", "%d минуту назад"},
		{"datetime_past_minute:1", "%d минуты назад"},
		{"datetime_past_minute:2", "%d минут назад"},
		{"datetime_past_second:0", "%d секунду назад"},
		{"datetime_past_second:1", "%d секунды назад"},
		{"datetime_past_second:2", "%d секунд назад"},
		{"delete_contest", "Удалить соревнование"},
		{"description", "Описание"},
		{"disabled", "Выключено"},
		{"duration_day:0", "%d день"},
		{"duration_day:1", "%d дня"},
		{"duration_day:2", "%d дней"},
		{"duration_millisecond:0", "%d миллисекунда"},
		{"duration_millisecond:1", "%d миллисекунды"},
		{"duration_millisecond:2", "%d миллисекунд"},
		{"duration_second:0", "секунда"},
		{"duration_second:1", "секунды"},
		{"duration_second:2", "секунд"},
		...
		{"logout", "Выйти"},
		{"manage", "Управление"},
		{"member_manager", "Менеджер"},
		{"member_regular", "Участник"},
		{"member", "Участник"},
