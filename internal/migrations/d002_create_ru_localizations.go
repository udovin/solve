...
func (m d002) Apply(ctx context.Context, db *gosql.DB) error {
	...
	localizations := [][2]string{
		...
		{"group_member_not_found", "Участник группы не найден"},
		...
		{"invalid_group_id", "Неправильный ID группы."},
		{"invalid_group_member_id", "Неправильный ID участника группы."},
		{"invalid_participant_id", "Неправильный ID участника."},
		{"invalid_password", "Неверный пароль."},
		{"invalid_post_id", "Неправильный ID поста."},
